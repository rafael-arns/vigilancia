# Inclusão e Tratamento de dados CadUnico municipal
...
```{r eval=FALSE}
# setwd("~/ <informar o caminho de pastas até a que contém os arquivos que serão utilizados>")
unzip("domicilio.zip")
unzip("pessoa.zip")
```
...
pessoa <- read_delim("~/<informar o caminho de pastas até a que contém os arquivos que serão utilizados>", 
